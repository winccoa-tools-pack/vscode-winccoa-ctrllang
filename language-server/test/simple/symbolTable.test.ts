...
import { SymbolTable, SymbolKind, AccessModifier, ClassSymbol, StructSymbol, MemberSymbol, MethodSymbol } from '../../src/symbolTable';
...
suite('SymbolTable - Symbol Resolution', () => {
    ...
    test('resolves symbol in class scope', () => {
        const content = fs.readFileSync(
            path.join(__dirname, './fixtures/scope-resolution.ctl'),
            'utf-8'
        );
    ...
    test('resolves class name from file scope', () => {
        const content = fs.readFileSync(
            path.join(__dirname, './fixtures/class-simple.ctl'),
            'utf-8'
        );
...
`;
    ...
    test('finds multiple classes in one file', () => {
        const content = fs.readFileSync(
            path.join(__dirname, './fixtures/class-multiple.ctl'),
            'utf-8'
        );
    ...
    test('respects private/public access modifiers', () => {
        const content = fs.readFileSync(
            path.join(__dirname, './fixtures/class-members.ctl'),
            'utf-8'
        );
    ...
    test('finds class inheritance', () => {
        const content = fs.readFileSync(
            path.join(__dirname, './fixtures/class-inheritance.ctl'),
            'utf-8'
        );
...
suite('SymbolTable - Struct Parsing', () => {
    ...
    test('finds simple struct definition', () => {
        const content = fs.readFileSync(
            path.join(__dirname, './fixtures/struct-simple.ctl'),
            'utf-8'
        );
...
suite('SymbolTable - Find References', () => {
    ...
    test('finds all references to class member', () => {
        const content = fs.readFileSync(
            path.join(__dirname, './fixtures/member-access.ctl'),
            'utf-8'
        );
...
suite('SymbolTable - Cross-File Resolution', () => {
    ...
    test('finds struct from dependency file', () => {
        ...
        const dataStructuresContent = fs.readFileSync(
            path.join(__dirname, '../../../test-workspace/scripts/libs/DataStructures.ctl'),
            'utf-8'
        );
    ...
    test('finds class from dependency file', () => {
        ...
        const derivedClassContent = fs.readFileSync(
            path.join(__dirname, '../../../test-workspace/scripts/libs/DerivedClass.ctl'),
            'utf-8'
        );
    ...
    test('finds global function from dependency file', () => {
        ...
        const utilContent = fs.readFileSync(
            path.join(__dirname, '../../../test-workspace/scripts/libs/UtilityFunctions.ctl'),
            'utf-8'
        );
