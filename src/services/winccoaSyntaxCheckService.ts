...
export class WinccoaSyntaxCheckService {
    ...
    constructor(outputChannel: vscode.OutputChannel) {
        this.diagnosticCollection = vscode.languages.createDiagnosticCollection('winccoa-syntax');
    ...
    private parseOutput(output: string, checkedFilePath: string): vscode.Diagnostic[] {
